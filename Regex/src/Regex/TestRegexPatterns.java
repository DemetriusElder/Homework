...
public class TestRegexPatterns {
	...
	public void testEmail2() {
		assertTrue("Failed email case 3",RegexPatterns.testEmail("email-email_email@email.com"));
	}
	...
	public void testEmail5() {
		assertTrue("Failed email case 6",RegexPatterns.testEmail("e______________________mail@email.com"));
	}
	...
	public void testAddress0() {
		assertTrue("Failed address case 1",RegexPatterns.testAddress("1 Atlantic Ave.\nAtlanta, GA 30313"));
	}

	@Test
	public void testAddress1() {
		assertTrue("Failed address case 2",RegexPatterns.testAddress("12 Atlantic Ave.\nAtlanta, GA 30313"));
	}

	@Test
	public void testAddress2() {
		assertTrue("Failed address case 3",RegexPatterns.testAddress("123 Atlantic Ave.\nAtlanta, GA 30313"));
	}

	@Test
	public void testAddress3() {
		assertTrue("Failed address case 4",RegexPatterns.testAddress("1234 Atlantic Ave.\nAtlanta, GA 30313"));
	}

	@Test
	public void testAddress4() {
		assertTrue("Failed address case 5",RegexPatterns.testAddress("12345 Atlantic Ave.\nAtlanta, GA 30313"));
	}

	@Test
	public void testAddress5() {
		assertFalse("Failed address case 6",RegexPatterns.testAddress("123456 Atlantic Ave.\nAtlanta, GA 30313"));//6 leading digits
	}

	@Test
	public void testAddress6() {
		assertTrue("Failed address case 7",RegexPatterns.testAddress("123 A\nAtlanta, GA 30313"));
	}

	@Test
	public void testAddress7() {
		assertTrue("Failed address case 8",RegexPatterns.testAddress("123 lowercase\nAtlanta, GA 30313"));
	}
	...
	public void testAddress9() {
		assertTrue("Failed address case 10",RegexPatterns.testAddress("123 Atlantic Ave.\natlanta, GA 30313"));
	}

	@Test
	public void testAddress10() {
		assertTrue("Failed address case 11",RegexPatterns.testAddress("123 Atlantic Ave.\nAtlanta GA 30313"));
	}
	...
	public void testAddress12() {
		assertFalse("Failed address case 13",RegexPatterns.testAddress("123 Atlantic Ave.\nAtlanta, ga 30313"));//state should be caps
	}

	@Test
	public void testAddress13() {
		assertFalse("Failed address case 14",RegexPatterns.testAddress("123 Atlantic Ave.\nAtlanta, GA 30"));//invalid zip code
	}

	@Test
	public void testAddress14() {
		assertFalse("Failed address case 15",RegexPatterns.testAddress("123 Atlantic Ave.\nAtlanta, GA 30313-5124"));//invalid zip code
	}

	@Test
	public void testAddress15() {
		assertTrue("Failed address case 16",RegexPatterns.testAddress("100 The Moon\nCity, NA 00000"));
	}

	@Test
	public void testAddress16() {
		assertTrue("Failed address case 17",RegexPatterns.testAddress("100 First-Street Cir.\nSt. Lewis, NA 00000"));
	}

	@Test
	public void testAddress17() {
		assertTrue("Failed address case 18",RegexPatterns.testAddress("100 First-Street Cir.\nNorth-Ridge, NA 00000"));
	}

	@Test
	public void testAddress18() {
		assertFalse("Failed address case 19",RegexPatterns.testAddress("First-Street Cir.\nNorth-Ridge, NA 00000"));//no leading digits
	}
	...
	public void testJavaExec0() {
		assertTrue("Failed Java method case 1",RegexPatterns.testJavaExecutable("public static void main(String[] args)"));
	}

	@Test
	public void testJavaExec1() {
		assertTrue("Failed Java method case 2",RegexPatterns.testJavaExecutable("\n //  ///*\"public static void main(String[] args)\"*/ \n "));
	}

	@Test
	public void testJavaExec2() {
		assertFalse("Failed Java method case 3",RegexPatterns.testJavaExecutable("\n  public void main(String[] args)  \n"));
	}
}